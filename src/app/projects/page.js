...
//   {
//     title: "Offgrid",
//     description: "A space that serves as inspiration, offering a mix of colors and typography to spark creativity.",
//     image: "",
//     link: "https://offgrid.cristinasevi.com/",
...
//     return (
//         <section id="projects" className="w-full min-h-screen py-32 px-6">
//             <h1 className={`${SuisseIntlMedium.className} text-[#0055FF]`}>my projects</h1>
//         </section>
//     )
// }
...
const projects = [
  {
    title: "Paint95",
    description:
      "Relive the classic Windows 95 Paint in your browser. A nostalgic recreation with modern web technologies.",
    image: "/images/paint95.png",
    link: "https://paint95.cristinasevi.com/",
    technologies: ["HTML", "CSS", "JavaScript"],
  },
  {
    title: "Offgrid",
    description:
      "A space that serves as inspiration, offering a mix of colors and typography to spark creativity.",
    image: "",
    link: "",
    technologies: ["React.js", "Tailwind CSS", "Next.js"],
  },
  ...
  return (
    <section id="projects" className="w-full min-h-screen py-32 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="">
          <div className="grid grid-cols-[1fr,1.5fr] gap-16 items-center">
            <div className="space-y-8">
              <motion.h2 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className={`${SuisseIntlMedium.className} text-6xl md:text-8xl font-light text-[#0055FF]`}>
                my
                <br/>
                <span>projects</span>
              </motion.h2>
              ...
              >
                {projects.map((project, index) => (
                  <motion.button
                    key={project.title}
                    className={`block text-left w-full p-4 rounded-lg transition-colors ${
                      currentProject === index ? "bg-[#1a1a1a]" : "hover:bg-[#1a1a1a]/50"
                    }`}
            ...
            <div className="relative">
                      ...
                      {projects[currentProject].technologies.map((tech) => (
                        <motion.span
                          ...
                          className={`px-4 py-2 rounded-full text-sm transition-colors ${
                            hoveredTech === tech ? "bg-[#0000FF] text-white" : "bg-white/10 backdrop-blur-sm"
                          }`}
                        >
                          {tech}
                        </motion.span>
              ...
              <motion.div
                className="absolute -inset-4 rounded-2xl bg-[#0000FF]"
                initial={{ opacity: 0 }}
                animate={{ opacity: 0.1 }}
